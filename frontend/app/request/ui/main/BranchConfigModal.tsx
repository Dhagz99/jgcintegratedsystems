                        ...
                        <thead className="text-xs text-gray-700 uppercase bg-gray-100 ">
                            ...
                            <tbody>
                                    ...
                                    data?.map((branch: Branch) =>(
                                        <tr key={branch.id} className="bg-white border-b border-gray-200 hover:bg-gray-50 cursor-pointer">
                                            <td className="px-6 py-1.5">
                                              <ButtonGroup onEdit={()=> handleEditChecker(branch)} onDelete={() => handleDelete(branch)} />
                                            </td>
                                            <td className="px-6 py-1.5">{branch.branchCode}</td>
                                            <td className="px-6 py-1.5">{branch.branchName}</td>
                                            <td className="px-6 py-1.5">{branch.bom}</td>
                                            <td className="px-6 py-1.5">{branch.faa}</td>
                                        </tr>
                                    ))
